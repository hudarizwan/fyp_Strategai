...
class AnalyticsOutput(BaseModel):
    ...
    primary_pricing_mode: Optional[str] = None
    alternate_pricing_modes: List[str] = Field(default_factory=list)
    pricing_modes: Dict[str, Dict[str, Any]] = Field(default_factory=dict)
