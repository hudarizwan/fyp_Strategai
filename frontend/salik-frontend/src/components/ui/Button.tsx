    ...
    return (
      <motion.button
        className={cn(
          ...
          {
            'rounded-full border border-white/10 bg-gradient-to-b from-white/12 to-white/6 text-white shadow-[0_12px_30px_rgba(2,6,23,0.28)] backdrop-blur-xl hover:border-white/20 hover:bg-white/15': variant === 'default',
            'rounded-full border border-white/10 bg-transparent text-white hover:border-white/20 hover:bg-white/8': variant === 'outline',
